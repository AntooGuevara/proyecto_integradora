...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-12-2025 a las 23:24:53
...
INSERT INTO `articulos` (`id`, `categoria_id`, `nombre`, `descripcion`, `estado`, `precio_renta`, `fecha_adquisicion`) VALUES
(1, 1, 'Brincolín Grande', 'Brincolín inflable 4x4 metros', 'disponible', 800.00, '2024-01-15'),
(2, 1, 'Tobogán Inflable', 'Tobogán inflable con piscina de pelotas', 'disponible', 1200.00, '2024-02-20'),
(3, 2, 'Mesa Rectangular', 'Mesa para 10 personas', 'disponible', 150.00, '2024-03-10'),
(4, 2, 'Silla Plegable', 'Silla plegable plástica', 'disponible', 20.00, '2024-01-30'),
(5, 3, 'Equipo de Sonido', 'Parlantes, micrófonos y mezcladora', 'disponible', 1000.00, '2024-02-15'),
(6, 3, 'Luces LED', 'Kit de luces para fiestas', 'disponible', 300.00, '2024-03-05'),
(7, 4, 'Juego de Mesa', 'Juego de mesa gigante', 'disponible', 250.00, '2024-01-20');
...
INSERT INTO `detalle_reservacion` (`id`, `reservacion_id`, `articulo_id`, `cantidad`, `precio_unitario`, `subtotal`) VALUES
(3, 3, 6, 1, 100.00, 100.00),
...
INSERT INTO `reservaciones` (`id`, `cliente_id`, `usuario_id`, `estado`, `fecha_reservacion`, `fecha_evento`, `fecha_entrega`, `fecha_devolucion`, `total`, `observaciones`) VALUES
(3, 5, 1, 'en_proceso', '2025-12-14 19:12:52', '2025-12-14', '2025-12-14', NULL, 100.00, 'Alquiler: Luces LED | Cliente: antonio'),
(4, 1, 1, 'pendiente', '2025-12-14 21:20:22', '2025-12-14', '2025-12-14', NULL, 100.00, 'Alquiler: Mesa Rectangular | Cliente: jose');
...
(1, 'admin', 'admin123', 'admin@gmail.com', 'admin', 'admin', 1, '2025-11-23 18:04:47', '2025-12-14 22:23:27');
